...
## Features added on top of the port (0.3.1.1f4)
...
2. **Floating Hex Notebook.** The "docs" key (N by default, rebindable) no longer
...
The built jar lands in `build/libs/hexcessible-forge-1.20.1-0.3.1.1f4.jar`. To
run a dev client:
